    ...
    public class CameraControler : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (Input.GetMouseButton(1))
            {
                ...
                cameraA.transform.rotation = Quaternion.Euler(m_deltY, m_deltX, 0);
            }
            ...
            if (Input.GetAxis("Mouse ScrollWheel") != 0)
            {
                ...
                cameraA.transform.localPosition = cameraA.transform.position + cameraA.transform.forward * m_distance * moveSpd;
            }
            ...
            {
                m_distance = 10.0f;
                cameraA.transform.localPosition = new Vector3(0, m_distance, 0);
            }
        }

...
namespace Artngame.SKYMASTER
{
    ...
    public sealed class NebulaCloudsSM_HDRP : CustomPostProcessVolumeComponent, IPostProcessComponent
    {
        ...
        //public bool initPlanetAtmosphere = false;
        ...
        ////public RenderTextureParameter transmittanceTest = new RenderTextureParameter(null);
        //// public RenderTextureParameter irradianceTest = new RenderTextureParameter(null);
        //// public RenderTextureParameter inscatterTest = new RenderTextureParameter(null);
        ...
        //    Artngame.BrunetonsAtmosphere.CBUtility.WriteIntoRenderTexture(m_transmittance, TRANSMITTANCE_CHANNELS, path, buffer, m_writeData);
        //    buffer.Release();
        ...
        //    Artngame.BrunetonsAtmosphere.CBUtility.WriteIntoRenderTexture(m_inscatter, INSCATTER_CHANNELS, path, buffer, m_writeData);
        //    buffer.Release();
        ...
        //    Artngame.BrunetonsAtmosphere.CBUtility.WriteIntoRenderTexture(m_irradiance, IRRADIANCE_CHANNELS, path, buffer, m_writeData);
        //    buffer.Release();

        //    //debug
        //    Debug.Log("Made textures");
        //    if (t_atmosphereImageEffect != null)
        //    {
        //        t_atmosphereImageEffect.mainTexture = m_irradiance;
        //        t_atmosphereImageEffect.SetTexture("_BaseColorMap", m_irradiance);
        //    }
        //    ///transmittanceTest.value = m_irradiance;
        //    //inscatterTest.value = m_inscatter;
        //    //transmittanceTest.value = m_transmittance;
        //}
        //void UpdatePLANET_ATMO(Material m_atmosphereImageEffect)
        //{
        //    Camera mainCam = Camera.main;
        //    UpdateMat(m_atmosphereImageEffect);
        //    //mainCam.farClipPlane = Mathf.Max(MinViewDistance, (transform.position - transform.position.normalized * (RG * SCALE / 3f)).magnitude);
        //    UpdateRenderBuffer(m_atmosphereImageEffect);
        //}
        //private void UpdateRenderBuffer(Material mat)
        //{
        //    Camera mainCam = Camera.main;
        ...
        //    Matrix4x4 viewProjInverse = (mainCam.projectionMatrix * mainCam.worldToCameraMatrix).inverse;
        //    mat.SetMatrix("_ViewProjectInverse", viewProjInverse);
        //    Matrix4x4 CameraInv = mainCam.cameraToWorldMatrix.inverse;
        //    mat.SetMatrix("_CameraInv", CameraInv);
        //    mat.SetMatrix("_ViewMatrix", mainCam.worldToCameraMatrix);
        //    mat.SetFloat("_FarPlane", mainCam.farClipPlane);
        //    mat.SetFloat("imageFXBlend", imageFXBlend);
        //    //mat.SetTexture("_CameraDepthNormalsTexture", BuiltinRenderTextureType.GBuffer2);
        //}
        //void UpdateMat(Material mat)
        //{
        //    mat.SetVector("betaR", m_betaR / SCALE);
        //    mat.SetFloat("mieG", m_mieG);
        //    mat.SetVector("SUN_DIR", sunLight.transform.forward * -1);
        //    mat.SetFloat("SUN_INTENSITY", m_sunIntensity);
        //    mat.SetVector("EARTH_POS", EarthPosition);
        //    mat.SetVector("CAMERA_POS", Camera.main.transform.position);
        ...
        //    mat.SetFloat("SUN_INTENSITY", m_sunIntensity);
        //    mat.SetVector("SUN_DIR", sunLight.transform.forward * -1.0f);
        //}
        ////void OnDestroy()
        ////{
        ...
        ////}
        //void InitializePLANET_ATMO(Material m_atmosphereImageEffect)
        //{
        ...
        public void passParamsToClouds(connectSuntoNebulaCloudsHDRP connector)
        {
            ...
            if (1 == 1)
            {
                ...
                ////v0.8 - PLANETARY ATMOSPHERE
                //shafts.enablePlanetAtmosphere = connector.enablePlanetAtmosphere;
                ////shafts.initPlanetAtmosphere = connector.initPlanetAtmosphere;
                //shafts.SCALE = connector.SCALE;
                //shafts.TRANSMITTANCE_WIDTH = connector.TRANSMITTANCE_WIDTH;
                //shafts.TRANSMITTANCE_HEIGHT = connector.TRANSMITTANCE_HEIGHT;
                //shafts.TRANSMITTANCE_CHANNELS = connector.TRANSMITTANCE_CHANNELS;
                //shafts.IRRADIANCE_WIDTH = connector.IRRADIANCE_WIDTH;
                //shafts.IRRADIANCE_HEIGHT = connector.IRRADIANCE_HEIGHT;
                //shafts.IRRADIANCE_CHANNELS = connector.IRRADIANCE_CHANNELS;
                //shafts.INSCATTER_WIDTH = connector.INSCATTER_WIDTH;
                //shafts.INSCATTER_HEIGHT = connector.INSCATTER_HEIGHT;
                //shafts.INSCATTER_DEPTH = connector.INSCATTER_DEPTH;
                //shafts.INSCATTER_CHANNELS = connector.INSCATTER_CHANNELS;
                //shafts.m_betaR = connector.m_betaR;
                //shafts.m_mieG = connector.m_mieG;
                //shafts.m_sunIntensity = connector.m_sunIntensity;
                //shafts.t_atmosphereImageEffect = connector.t_atmosphereImageEffect;
                //shafts.EarthPosition = connector.EarthPosition;
                //shafts.RG = connector.RG;
                //shafts.RT = connector.RT;
                //shafts.RL = connector.RL;
                //shafts.HR = connector.HR;
                //shafts.HM = connector.HM;
                //shafts.MinViewDistance = connector.MinViewDistance;
                //shafts.m_writeData = connector.m_writeData;
                //shafts.imageFXBlend = connector.imageFXBlend;
                ////////////////
                                                                                                                            ...
                                                                                                                            //public override void Render(PostProcessRenderContext context)
        {
            ...
            //v0.8 - PLANETARY ATMOSPHERE
            //if (enablePlanetAtmosphere)
            //{
            //    if (!initPlanetAtmosphere || m_transmittance == null)
            //    {
            //        InitializePLANET_ATMO(CloudMaterial);
            //        initPlanetAtmosphere = true;
            //    }
            //    UpdatePLANET_ATMO(CloudMaterial);
            //}

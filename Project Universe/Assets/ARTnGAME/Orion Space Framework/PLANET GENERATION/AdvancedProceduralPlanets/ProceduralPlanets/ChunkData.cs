...
namespace Artngame.Orion.PlanetGEN
{
    ...
    public class ChunkData : IDisposable
    {
        ...
        public IEnumerator StartGenerateCoroutine(bool fastMode)//v0.1
        {
            ...
            if (fastMode)//v0.1
            {
                planet.currentStep = "GenerateHeightMap";
                GenerateHeightMap();
                //planet.currentStep = "SimulateErosion";
                //SimulateErosion();
                planet.currentStep = "GenerateMesh";
                GenerateMesh();

               // yield return new WaitForEndOfFrame();
               // if (generatingData == null) yield break; // aborted

                planet.currentStep = "GenerateNormalMap";
                GenerateNormalMap();

               // yield return new WaitForEndOfFrame();
               // if (generatingData == null) yield break; // aborted

                planet.currentStep = "RequestMeshData";
                RequestMeshData();
                ...
                planet.currentStep = "GenerateDiffuseMap";
                GenerateDiffuseMap();
                planet.currentStep = "END A";
                //yield return new WaitForEndOfFrame();
               // if (generatingData == null) yield break; // aborted
            }
            else
            ...
            //if (!fastMode){//v0.1
            while (!getMeshDataReadbackRequest.done)// || (getMeshDataReadbackRequest.done && getMeshDataReadbackRequest.hasError))
            {
                planet.currentStep = "not getMeshDataReadbackRequest";
                yield return new WaitForEndOfFrame();
                if (generatingData == null) yield break; // aborted
            }
            //}
            ...
            if (fastMode)//v0.1
            {
               ...
               // if (generatingData == null) yield break; // aborted
                ...
                planet.currentStep = "UploadMesh";
                UploadMesh();
                planet.currentStep = "BakePhysXCollisionData";
                BakePhysXCollisionData();
                planet.currentStep = "CleanupAfterGeneration";
                CleanupAfterGeneration();
                planet.currentStep = "END B";
        ...
        void SetAll(ComputeShader c, int kernelIndex)
        {
           ...
           // if (generatingData.chunkHeightMap != null) c.SetTexture(kernelIndex, "_chunkWorldNormalMap", generatingData.chunkHeightMap);
          //  if (generatingData.chunkHeightMap != null) c.SetTexture(kernelIndex, "_chunkTangentNormalMap", generatingData.chunkHeightMap);
        ...
        {
            planet.currentStep = "GenerateHeightMap A";
            ...
            planet.currentStep = "GenerateHeightMap B";
        }
        ...
        {
            planet.currentStep = "GenerateNormalMap A";
            ...
            if (generatingData.chunkTangentNormalMap != null && generatingData.chunkTangentNormalMap.width != TangentNormalMapResolution)
            {
                ...
                RenderTexture.Destroy(generatingData.chunkTangentNormalMap);
            ...
            //    RenderTexture.Destroy(generatingData.chunkDiffuseMap);
            ...
            planet.currentStep = "GenerateNormalMap B";
        }
        ...
        void GenerateMesh()
        {
            planet.currentStep = "GenerateMesh A";
            ...
            planet.currentStep = "GenerateMesh B";
        }
        ...
        {
            planet.currentStep = "RequestMeshData A";
            //v0.1
           ...
           // if (getMeshDataReadbackRequest.done && vertexGPUBuffer != null)
            {
                getMeshDataReadbackRequest = AsyncGPUReadback.RequestIntoNativeArray(ref vertexCPUBuffer, vertexGPUBuffer);
                //getMeshDataReadbackRequest = AsyncGPUReadback.RequestIntoNativeArray(ref vertexCPUBuffer, vertexGPUBuffer, OnCompleteReadBack(getMeshDataReadbackRequest));

                //AsyncGPUReadback.WaitAllRequests();

            }
            MyProfiler.EndSample();
            //UnityEngine.Debug.Log("BBBBBBBBBBBB11");
            planet.currentStep = "RequestMeshData B";
        }

        System.Action<AsyncGPUReadbackRequest> OnCompleteReadBack(AsyncGPUReadbackRequest request)
        {
            ...
            //UnityEngine.Debug.Log("BBBBBBBBBBBB1");
            if (request.hasError == false)
            {
                //CreateMesh();
               // UnityEngine.Debug.Log("BBBBBBBBBBBB");
                //var data = request.GetData<myStruct>();
                //request = AsyncGPUReadback.RequestIntoNativeArray(ref vertexCPUBuffer, vertexGPUBuffer);
                return null;// AsyncGPUReadback.RequestIntoNativeArray(ref vertexCPUBuffer, vertexGPUBuffer);
            }
            else
            {
                return null;
        ...
        void CreateMesh()
        {
           // if (getMeshDataReadbackRequest.done && vertexCPUBuffer != null && !getMeshDataReadbackRequest.hasError)
            {
                planet.currentStep = "CreateMesh A";
                var verticesOnEdge = chunkConfig.numberOfVerticesOnEdge;
                ...
                //}
                planet.currentStep = "CreateMesh B";
            }
        }

        void UploadMesh()
        {
            planet.currentStep = "UploadMesh A";
            ...
            planet.currentStep = "UploadMesh B";
        }
        ...
        {
            planet.currentStep = "GenerateDiffuseMap A";
            ...
            planet.currentStep = "GenerateDiffuseMap B";
        }
        ...
        public void Dispose()
        {
            ...
            planet.currentStep = "Dispose B";
        }

        public void ReleaseGeneratedData()
        {
            planet.currentStep = "ReleaseGeneratedData A";
            Dispose();
            planet.currentStep = "ReleaseGeneratedData B";
        }

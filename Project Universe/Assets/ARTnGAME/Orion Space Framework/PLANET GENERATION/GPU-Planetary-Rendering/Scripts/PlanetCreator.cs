...
namespace Artngame.Orion.PlanetCreator
{
    ...
    public class PlanetCreator : MonoBehaviour
    {
        ...
        public void UpdateChunkMesh(PlanetChunkObject chunk)
        {
            ...
            {
                chunk.Filter.sharedMesh = CopyMesh(BasicPlane, planetCenter);
            }
            ...
            float Size, int LodLevel, Vector2 min)
        {
            ...
            //v0.1
            chunk.Center = planetCenter + (chunk.Rotation * new Vector3(chunk.Middle.x - 0.5f, 1f, chunk.Middle.y - 0.5f)).normalized *
                           SphereRadius;
        ...
        public void CaluclateVertex(PlanetChunkObject chunk)
        {
            ...
            chunk.name = "Recycled Mesh, Center = " + planetCenter + ", Radius = " + PlanetRadius;
            chunk.Filter.sharedMesh.SetUVs(0, uvsTmp);

            //v0.1
            chunk.transform.position = planetCenter;
        ...
        public static Mesh CopyMesh(Mesh mesh, Vector3 planetCenter)
        {
            //v0.1
            // return Instantiate(mesh);
            return Instantiate(mesh, planetCenter, Quaternion.identity);
        }

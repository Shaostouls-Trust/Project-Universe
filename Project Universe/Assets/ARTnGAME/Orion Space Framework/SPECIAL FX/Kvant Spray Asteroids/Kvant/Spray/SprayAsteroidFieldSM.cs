...
namespace Artngame.Orion.Kvant
{
    ...
    public partial class SprayAsteroidFieldSM : MonoBehaviour
    {
        ...
        public Vector3 vortexCenter = new Vector3(0,0,0);
        ...
        BulkMeshAsteroidFieldSM _bulkMesh;
        ...
        {
            if (_bulkMesh == null)
                _bulkMesh = new BulkMeshAsteroidFieldSM(_shapes);
            else

...
namespace CsPotrace
{
    ...
    public partial class Potrace
    {
        ...
        {
           // UnityEngine.Debug.Log("******* SEARCH FOR BLACK");

            for ( y = 1; y < Matrix.GetLength( 1 ) - 1; y++ )
                for( x = 0; x < Matrix.GetLength( 0 ) - 1; x++ )
                    if(!Matrix[x + 1, y] ) // black found
                    {
                        //UnityEngine.Debug.Log("******* BLACK FOUND AFTER: " + (x) + ", " + y);

                        return true;
                    }
                        

            //UnityEngine.Debug.Log("******* NO BLACK FOUND");
            x = -1;
            return false;
        }
        // <summary>
        ...
        static Path findpath( bool[,] Matrix, IntPoint Start )
        {
            ...
            do
            {
                ...
                int _y = y;
                //UnityEngine.Debug.Log("HERE "+ x + ", " + y);
        ...
        {
            //UnityEngine.Debug.Log("==== findNextTrace - " + x + ", " + y + " : " + Dir);
            ...
            switch ( Dir )
            {
                ...
                case Direction.East:
                    {
                        //if (x > Matrix.GetLength(0)-10)
                        //    UnityEngine.Debug.Log("x=" + Matrix.GetLength(0));
                        //if (y > Matrix.GetLength(1)-10)
                        //    UnityEngine.Debug.Log("y=" + Matrix.GetLength(1));

                        //UnityEngine.Debug.Log(x + " : " +y+" ++ " + Matrix.GetLength(0));
        ...
        static void BestPolygon( Path pp )
        {
            ...
            //UnityEngine.Debug.Log("PATH: " + pp.pt.Length);

            //for (i=0; i<300; i++)
            //{
            //    ubug.Log(pp.pt[i].X + ", " + pp.pt[i].Y);
            //}
   ...
   on failure. */
        ...
        {
            //UnityEngine.Debug.Log("====== getContur " + x + ", "+y);

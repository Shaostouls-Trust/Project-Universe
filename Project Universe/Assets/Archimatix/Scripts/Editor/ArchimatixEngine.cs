...
namespace AXEditor	 
{
	...
	public class ArchimatixEngine  {
		...
		public static string[] nodeStrings 					= {   "FreeCurve", "ShapeDistributor","ShapeChanneler", "ShapeConnector", "ShapeMerger", "ShapeOffsetter",    "PairRepeater2D", "LinearRepeater2D", "GridRepeater2D", "RadialRepeater2D",  "PlanRepeater2D",  "PlanePrimitive", "BoxPrimitive", "Polygon", "Extrude", "Lathe", "PlanSweep",  "ContourExtruder", "Grouper", "Channeler", "PairRepeater", "LinearRepeater", "GridRepeater", "FloorRepeater", "StepRepeater", "RadialRepeater", "RadialStepRepeater", "PlanPlacer", "PlanRepeater", "NoiseDeformer", "TaperDeformer",  "ShearDeformer", "TwistDeformer", "DomicalDeformer",  "InflateDeformer",  "PlanDeformer", "TerrainDeformer", "TerrainStamper", "PhysicsJoiner", "PrefabInstancer", "RepeaterTool", "RadialRepeaterTool",  "MaterialTool","JitterTool"  };

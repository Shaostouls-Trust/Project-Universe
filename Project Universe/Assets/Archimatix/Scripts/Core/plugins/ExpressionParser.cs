...
namespace AX.Expression
{
    ...
    public class ExpressionParser
    {
        ...
        public ExpressionParser()
        {
            ...
            m_Funcs.Add("sin", (p) => System.Math.Sin(p.FirstOrDefault() * Mathf.Deg2Rad));
            m_Funcs.Add("cos", (p) => System.Math.Cos(p.FirstOrDefault() * Mathf.Deg2Rad));
            m_Funcs.Add("tan", (p) => System.Math.Tan(p.FirstOrDefault() * Mathf.Deg2Rad));

            m_Funcs.Add("asin", (p) => System.Math.Asin(p.FirstOrDefault()) * Mathf.Rad2Deg);
            m_Funcs.Add("acos", (p) => System.Math.Acos(p.FirstOrDefault()) * Mathf.Rad2Deg);
            m_Funcs.Add("atan", (p) => System.Math.Atan(p.FirstOrDefault()) * Mathf.Rad2Deg);

            m_Funcs.Add("atan2",    (p) => System.Math.Atan2(p.FirstOrDefault(), p.ElementAtOrDefault(1)) * Mathf.Rad2Deg);

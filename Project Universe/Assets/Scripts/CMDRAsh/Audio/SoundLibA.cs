...
namespace ProjectUniverse.Audio
{
        ...
        public static Dictionary<string, string[]> soundParameters = new Dictionary<string, string[]>
    {
        ...
        {"NuclearLeak1",new string[]{ "Nuclear", "1.0f", "0.25","25","75","25","80"} },
        {"NuclearWarning1",new string[]{ "Nuclear", "1.0f", "0.25","25","75","25","79"} },
        {"NuclearWarning2",new string[]{ "Nuclear", "1.0f", "0.25","25","75","25","79"} },

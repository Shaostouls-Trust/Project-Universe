...
namespace ProjectUniverse.PowerSystem.Nuclear
{
    public class SteamGenerator : MonoBehaviour
    {
        ...
        private float coolantHotTemp = 373.12f;//temp from reactor
        ...
        [SerializeField] private float outputPressure = 210.75f;
        ...
        private void Update()
        {
            ...
            if (waterStored_monitor < waterStoredMax)
            {
            ...
            if (!float.IsNaN(CoolantHotTemp))
            {
                ...
                hotQ = coolantFlowRateCurrent * 4184f * (CoolantHotTemp);//-300f or coolantCool
            }
            else
            {
                coolantLossHot = 300f;
